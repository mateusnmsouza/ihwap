...
cluster = parallel::makeForkCluster(nnodes=20, outfile="/projects/aces/nogueir2/ClusterOutputs/clust.out.predictpre_xgboost")
print(cluster)
...
saveRDS(fit.gaselec.SL, "/projects/aces/nogueir2/ModelOutputs/predictpre_model_xgboost")
...
saveRDS(data_export, '/projects/aces/nogueir2/ModelOutputs/predictpre_results_xgboost.rds')
write.csv(data_export, '/projects/aces/nogueir2/ModelOutputs/predictpre_results_xgboost.csv', row.names = FALSE)
...
saveRDS(data_export2, '/projects/aces/nogueir2/ModelOutputs/predictpost_results_xgboost.rds')
write.csv(data_export2, '/projects/aces/nogueir2/ModelOutputs/predictpost_results_xgboost.csv', row.names = FALSE)

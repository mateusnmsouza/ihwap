...
cluster = parallel::makeForkCluster(nnodes=20, outfile="/projects/aces/nogueir2/ClusterOutputs/clust.out.predictpre_rf")
print(cluster)
...
# read the data
ihwap_complete = read.csv("/projects/aces/nogueir2/Data/ihwap_full.csv")
...
parallel::clusterExport(cluster, randomForest$names)
...
saveRDS(fit.gaselec.SL, "/projects/aces/nogueir2/ModelOutputs/predictpre_model_rf")
...
saveRDS(data_export, '/projects/aces/nogueir2/ModelOutputs/predictpre_results_rf.rds')
write.csv(data_export, '/projects/aces/nogueir2/ModelOutputs/predictpre_results_rf.csv', row.names = FALSE)
...
saveRDS(data_export2, '/projects/aces/nogueir2/ModelOutputs/predictpost_results_rf.rds')
write.csv(data_export2, '/projects/aces/nogueir2/ModelOutputs/predictpost_results_rf.csv', row.names = FALSE)
